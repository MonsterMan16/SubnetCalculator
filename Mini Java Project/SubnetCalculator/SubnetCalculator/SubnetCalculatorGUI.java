...
public class SubnetCalculatorGUI {
    ...
    private class CalculatorGUI extends JFrame {
        ...
        private void subnetHistoryPanelGUI() {
...
//        subnetHistoryTable.setFillsViewportHeight(true);
        ...
        private void networkProperiesGUI() {
        ...
        private void networkProperiesLPanelGUI() {
...
//            subnetBtn.addActionListener(ButtonEventHandler);
        ...
        private void networkProperiesRPanelGUI() {
            GridLayout gridLayout = new GridLayout(10, 1);
        ...
        private void networkProperiesBottomPanelGUI() {
